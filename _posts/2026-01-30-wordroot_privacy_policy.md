---
layout: post
title: "Privacy Policy: 词根记单词"
date: 2026-01-30 19:37:00 +0800
categories: legal
permalink: /wordroot_app_privacy_policy/
---

<h1>隐私政策</h1>
<div>更新日期：<strong>2026/1/30</strong></div>
<div>生效日期：<strong>2026/1/30</strong></div>
<h2>导言</h2>
<p>
  <i>词根记单词</i> 是一款由 <i>Xu Chen</i> （以下简称“我们”）提供的产品。
  您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
  本《隐私政策》与您所使用的 <i>词根记单词</i> 服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
</p>
